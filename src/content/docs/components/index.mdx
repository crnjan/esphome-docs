---
description: "Browse all ESPHome components - sensors, switches, lights, displays, climate controllers, and more for ESP32, ESP8266, and RP2040."
title: "ESPHome Docs"
---
...
<ImgTable items={[
  ["Overview", "/automations/", "description.svg", "dark-invert"],
...
<ImgTable items={[
  ["Update Core", "/components/update/", "system-update.svg", "dark-invert"],
...
Platforms which specifically support or extend the [index](/components/one_wire/), allowing communication with
...
Platforms which specifically support or extend the [index](/components/canbus/), allowing communication with
CAN-based devices.
...
<ImgTable items={[
  ...
  ["HC8", "/components/sensor/hc8/", "hc8.png", "CO2 & Temperature & Humidity"],
...
<ImgTable items={[
  ...
  ["HLW8032", "/components/sensor/hlw8032/", "hlw8012.svg", "Voltage & Current & Power"],
...
<ImgTable items={[
  ...
  ["LTR559", "/components/sensor/ltr_als_ps/", "ltr501.jpg", "Lux & Proximity"],
...
[ADC Sensor](/components/sensor/adc/) together with a formula like in the [TEMT6000 configuration](https://devices.esphome.io/devices/temt6000).
...
<ImgTable items={[
  ["Binary Sensor Core", "/components/binary_sensor/", "folder-open.svg", "dark-invert"],
...
<ImgTable items={[
  ["Alarm Control Panel Core", "/components/alarm_control_panel/", "alarm-panel.svg", "dark-invert"],
...
<ImgTable items={[
  ["Audio ADC Core", "/components/audio_adc/", "audio_adc.svg"],
...
<ImgTable items={[
  ["Audio DAC Core", "/components/audio_dac/", "audio_dac.svg"],
...
<ImgTable items={[
  ["Button Core", "/components/button/", "folder-open.svg", "dark-invert"],
...
<ImgTable items={[
  ...
  ["Mitsubishi CN105 Climate", "/components/climate/mitsubishi_cn105/", "/images/mitsubishi_electric.png"],
...
<ImgTable items={[
  ["Cover Core", "/components/cover/", "folder-open.svg", "dark-invert"],
...
<ImgTable items={[
  ["Datetime Core", "/components/datetime/", "clock-outline.svg", "dark-invert"],
...
<ImgTable items={[
  ["Event Core", "/components/event/", "folder-open.svg", "dark-invert"],
...
<ImgTable items={[
  ["Infrared Core", "/components/infrared/", "remote.svg", "dark-invert"],
...
<ImgTable items={[
  ["Light Core", "/components/light/", "folder-open.svg", "dark-invert"],
...
[ESP32 RMT Led Strip](/components/light/esp32_rmt_led_strip/) or [SPI Led Strip](/components/light/spi_led_strip/); for other processors, have a look at the
[FastLED Light](/components/light/fastled/).

## Lock Components

<ImgTable items={[
  ["Lock Core", "/components/lock/", "folder-open.svg", "dark-invert"],
...
<ImgTable items={[
  ["Media Player Core", "/components/media_player/", "folder-open.svg", "dark-invert"],
  ...
  ["Speaker Source", "/components/media_player/speaker_source/", "speaker.svg", "dark-invert"],
]} />
...
<ImgTable items={[
  ["Number Core", "/components/number/", "folder-open.svg", "dark-invert"],
...
<ImgTable items={[
  ["Output Core", "/components/output/", "folder-open.svg", "dark-invert"],
...
<ImgTable items={[
  ["Select Core", "/components/select/", "folder-open.svg", "dark-invert"],
...
<ImgTable items={[
  ["Speaker Core", "/components/speaker/", "speaker.svg", "dark-invert"],
...
<ImgTable items={[
  ["Switch Core", "/components/switch/", "folder-open.svg", "dark-invert"],
...
<ImgTable items={[
  ["Text Core", "/components/text/", "folder-open.svg", "dark-invert"],
...
<ImgTable items={[
  ["Text Sensor Core", "/components/text_sensor/", "folder-open.svg", "dark-invert"],
...
<ImgTable items={[
  ["Time Core", "/components/time/", "clock-outline.svg", "dark-invert"],
...
<ImgTable items={[
  ["Water Heater Core", "/components/water_heater/", "water_heater.svg"],
